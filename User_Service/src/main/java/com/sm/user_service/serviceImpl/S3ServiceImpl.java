...
public class S3ServiceImpl implements S3Service {
	...
	public String saveFile(MultipartFile file, int id) {
		...
		try {
			...
			PutObjectResult putObjectResult = s3.putObject(bucket, "Profile/" + id + "/" + fileName.hashCode(),
					convFile);

			return fileName;
		} catch (IOException ex) {
			throw new RuntimeException("Multimedia couldn't be saved to S3 bucket");
		}
	}
	...
	public String getUrl() {
		return "https://" + bucket + ".s3." + region + ".amazonaws.com/Profile/";
	}
